...
UI_INPUT_BG = "#F0F0F2"
UI_TEXT_DARK = "#0A0A0A"
UI_TEXT_MUTED = "#9A9A9A"
UI_TEXT_LIGHT = "#FFFFFF"
UI_ACCENT = "#0A0A0A"
UI_ACCENT_DIM = "#333333"
UI_BUTTON_BG = "#0A0A0A"
UI_BUTTON_BG_DISABLED = "#D1D1D6"
UI_SUCCESS_BG = "#0A0A0A"
UI_BORDER = "#E0E0E5"
...
UI_NAV_BG = "#FFFFFF"
UI_NAV_ICON_SELECTED = "#0A0A0A"
UI_NAV_ICON_UNSELECTED = "#9A9A9A"
UI_NAV_TEXT_SELECTED = "#0A0A0A"
UI_NAV_TEXT_UNSELECTED = "#9A9A9A"
UI_NAV_INDICATOR_BG = "#F0F0F2"
